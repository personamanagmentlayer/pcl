...
const PROPERTY_DOCS: Record<string, string> = {
  ...
  // Skill properties
  items: 'List of skill items or capabilities.\n\nExample: `["Python", "TypeScript", "Code Review"]`',

  // Prompt properties
  system: 'System prompt defining persona behavior.\n\nShould describe:\n- Role and responsibilities\n- Expertise and knowledge\n- Communication style\n- Constraints and limitations',
