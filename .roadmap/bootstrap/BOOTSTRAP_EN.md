...
personas:
  ...
  - id: PRODUCT
    ...
    capabilities:
      [roadmap, user stories, prioritization, stakeholder management]
    skills:
      [
        User story mapping,
        Agile/Scrum,
  ...
  - id: UX
    ...
    constraints:
      [WCAG compliance, User testing validation, Design system consistency]
    tone: empathetic
  ...
  - id: AI_ARCHI
    ...
    skills:
      [
        ...
        AI orchestration (Kubeflow/MLflow),
  ...
  - id: AI_ENG
    ...
    constraints:
      [Reproducibility, Performance monitoring, Data quality validation]
    tone: practical
  ...
  - id: STANDARD_ARCHITECT
    ...
    capabilities:
      [
        ...
        protocol modeling,
        formal specification structuring,
        cross-standard alignment (ISO,
        RFC,
        W3C,
        CNCF),
        C4 modeling,
  ...
  - id: SPEC_EDITOR
    ...
    specialized_skills:
      [
        RFC 2119/8174 (requirement levels),
        ISO/IEC Directives,
        IEEE standards writing,
  ...
  - id: COMPLIANCE_ENGINEER
    ...
    capabilities:
      [
        ...
        quality assurance,
        test harness design,
        JSON Schema/OpenAPI validators,
        CI compliance pipelines,
      ]
    shared_skills:
      [
        COMMUNICATION,
    ...
    specialized_skills:
      [
        ...
        Boundary testing,
        Fuzz testing,
        Test automation frameworks (Pytest/Jest/JUnit),
  ...
  - id: STANDARD_GOVERNOR
    ...
    capabilities:
      [
        standard governance models,
        open consortium management,
        versioning & deprecation policy,
        consensus processes,
        policy design,
        RFC process frameworks,
        semantic versioning,
    ...
    constraints:
      [
        ...
        Community participation with sovereign control,
        Traceable decisions,
      ]
    tone: strategic
  ...
  - id: INTEROP_ENGINEER
    ...
    skills:
      [
        ...
        Language binding (Python/TypeScript/Go/Java),
  ...
  - id: CERTIFICATION_AUTHORITY
    ...
    capabilities:
      [
        ...
        PKI & trust registries,
        badge & signature systems,
      ]
    skills:
      [
        Certification level design (Bronze/Silver/Gold),
        Audit checklist creation,
        Scoring rubrics,
        Pass/fail criteria,
        Evidence collection,
  ...
  - id: IP_LICENSING_COUNSEL
    ...
    capabilities:
      [
        ...
        standards IP policies (RAND,
        FRAND),
        international law,
        license compatibility matrices,
        trademark policy frameworks,
        CLA/DCO systems,
        legal risk assessment,
      ]
    skills:
      [
        Open source license selection (MIT/Apache-2.0/GPL/BSD),
        License compatibility analysis,
        Dual licensing,
        Patent pooling,
        FRAND/RAND-Z commitments,
  ...
  - id: REFERENCE_IMPLEMENTER
    ...
    capabilities:
      [
        SDK development,
        CLI & tooling,
        validator & linter design,
        CI/CD automation,
        documentation as code,
        GitHub/GitLab,
        CI pipelines,
        conformance test runners,
        packaging & release systems,
      ]
    skills:
      [
        Multi-language SDK design (Python/TypeScript/Go),
        CLI tool development (Cobra/Click/Commander),
...
teams:
  ...
  - id: dream-team
    name: Dream Team
    members:
      [LTC, ARCHI, CRITIC, AUDIT, SIMPLIFY, SEC, AI_ARCHI, DEV, DEVOPS, UX]
    default_primary: ARCHI
    default_merge: consensus
  ...
  - id: standardization-extended
    ...
    members:
      [
        ...
        IP_LICENSING_COUNSEL,
        STANDARD_EVANGELIST,
        REFERENCE_IMPLEMENTER,
        EVOLUTION_CURATOR,
      ]
...
_PCL-Lite is an open-source project under CC-BY-4.0 (spec) and Apache-2.0 (tools) licenses._
