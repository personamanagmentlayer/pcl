...
import { analyze, SymbolTable, TypeChecker, Types, TypeKind, SymbolKind } from '../src/semantic';
  ...
  describe('symbol management', () => {
    it('should define and lookup symbols', () => {
      symbolTable.define({
        ...
        type: Types.String,
        declaration: null,
        span: { start: { line: 1, column: 0, offset: 0 }, end: { line: 1, column: 3, offset: 3 }, source: '' },
    ...
    it('should lookup symbols from parent scopes', () => {
      symbolTable.define({
        ...
        type: Types.Int,
        declaration: null,
        span: { start: { line: 1, column: 0, offset: 0 }, end: { line: 1, column: 5, offset: 5 }, source: '' },
        scope: symbolTable.getCurrentScope(),
      });
    ...
    it('should shadow symbols in inner scopes', () => {
      symbolTable.define({
        ...
        type: Types.Int,
        declaration: null,
        span: { start: { line: 1, column: 0, offset: 0 }, end: { line: 1, column: 1, offset: 1 }, source: '' },
        scope: symbolTable.getCurrentScope(),
      });
      ...
      symbolTable.define({
        ...
        declaration: null,
        span: { start: { line: 2, column: 0, offset: 10 }, end: { line: 2, column: 1, offset: 11 }, source: '' },
        scope: symbolTable.getCurrentScope(),
      });
...
describe('TypeChecker', () => {
  ...
  describe('type assignability', () => {
    it('should allow assigning to Any', () => {
      ...
      expect(typeChecker.isAssignableTo(Types.array(Types.String), Types.Any)).toBe(true);
    });
    ...
    it('should allow literal to base type', () => {
      expect(typeChecker.isAssignableTo(Types.literal('hello'), Types.String)).toBe(true);
      expect(typeChecker.isAssignableTo(Types.literal(42), Types.Int)).toBe(true);
      expect(typeChecker.isAssignableTo(Types.literal(true), Types.Bool)).toBe(true);
    });
