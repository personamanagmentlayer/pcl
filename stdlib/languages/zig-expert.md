...
name: zig-expert
version: 1.0.0
description: Expert knowledge in Zig systems programming, comptime metaprogramming, manual memory management, and C interoperability
category: languages
tags: [zig, systems-programming, comptime, memory-management, c-interop, low-level, performance]
