...
version: 1.1.0
description: >-
  Expert in SOC 2 compliance, trust service criteria, audit preparation, controls
  implementation, and security frameworks. Use when the user mentions compliance, audit,
  trust services, AICPA, controls, or security framework, or when the task involves Trust
  Service Criteria, SOC 2 Types, Security Common Criteria, or Control Implementation
  Framework.
category: security
tags:
  [soc2, compliance, audit, trust-services, aicpa, controls, security-framework]
