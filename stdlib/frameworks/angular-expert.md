...
name: angular-expert
version: 1.0.0
description: Expert knowledge in Angular framework, RxJS reactive programming, TypeScript, dependency injection, and enterprise application development
category: frameworks
tags: [angular, rxjs, typescript, dependency-injection, reactive, frontend, enterprise]
    ...
    <form [formGroup]="userForm" (ngSubmit)="onSubmit()">
      ...
      <div>
        ...
        <div *ngIf="email.invalid && email.touched">
          ...
          <small *ngIf="email.errors?.['emailTaken']">Email already taken</small>
        </div>
      </div>
