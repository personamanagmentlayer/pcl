# MongoDB Expert — Core Expertise

Reference material for the `mongodb-expert` skill. See [SKILL.md](../SKILL.md).
...
```javascript
// Force index usage
db.users.find({ age: 25, name: 'Alice' }).hint({ age: 1, name: 1 });
```
